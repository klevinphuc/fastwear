...
export const products: Product[] = [
  {
    id: "1", name: "Đầm hoa mẫu đơn", designer: "DIOR", price: 350000, deposit: 1500000,
    category: "Đầm Dự Tiệc", gender: "Nữ", occasion: ["Tiệc / Sự Kiện", "Cưới"], sizes: ["XS","S","M","L"],
    colors: ["#F6D7DF","#FFF8F1"], available: true, rating: 4.9,
    image: "/media/product-peony-dress.webp",
    images: ["/media/product-peony-dress.webp"],
  },
  {
    id: "2", name: "Áo khoác drop họa tiết", designer: "DIOR", price: 480000, deposit: 2000000,
    category: "Áo khoác", gender: "Unisex", occasion: ["Công Sở", "Tiệc / Sự Kiện"], sizes: ["S","M","L","XL"],
    colors: ["#c9bea8","#f4f1ea"], available: true, rating: 4.8,
    image: "/media/product-drop-jacket.webp",
    images: ["/media/product-drop-jacket.webp"],
  },
  {
    id: "3", name: "Nón bucket beige", designer: "DIOR", price: 420000, deposit: 1800000,
    category: "Phụ kiện", gender: "Unisex", occasion: ["Du Lịch", "Hàng Ngày"], sizes: ["Free"],
    colors: ["#d8ccb7","#f4efe7"], available: true, rating: 5.0,
    image: "/media/product-bucket-beige.webp",
  },
  {
    id: "4", name: "Túi Bow hồng", designer: "DIOR", price: 180000, deposit: 800000,
    category: "Phụ kiện", gender: "Nữ", occasion: ["Hàng Ngày"], sizes: ["Free"],
    colors: ["#f1cbd6"], available: true, rating: 4.6,
